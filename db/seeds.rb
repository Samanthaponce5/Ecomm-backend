...
product5 = Product.create(user_id: user6.id, title:'Reflective',type_of:'Nature',category:'landscape,shortstache,moody,cinematic,mountain',price:100, image:'https://artofvisuals.com/wp-content/uploads/2017/10/@shortstache-4.jpg')
...
product9 = Product.create(user_id: user2.id, title:'Stairs',type_of:'City',category:'cityscape, stairs, black, white',price:100, image:'https://images.squarespace-cdn.com/content/v1/5755a35501dbae3c6d1ba03e/1473713710592-7ET780LQ9WA1FWUHDMZD/ke17ZwdGBToddI8pDm48kEpVg-ILAPna1wRh-xAJ9fRZw-zPPgdn4jUwVcJE1ZvWQUxwkmyExglNqGp0IvTJZUJFbgE-7XRK3dMEBRBhUpwEv36x-EUL2-BSQ5feDhwGCbXuJBFqZ-erYzVouT8yOb9TwqchglLQOCYTRn7ZGxI/trashhand+photography-metal+stairway.jpg')
product10 = Product.create(user_id: user1.id, title:'Japan',type_of:'City',category:'cityscape, city, japan, orange, teal',price:100, image:'https://images.squarespace-cdn.com/content/v1/5567ede4e4b0e2f8eac07860/1499395662220-SIFQAAMI9A3AMEO0BTKU/ke17ZwdGBToddI8pDm48kLkXF2pIyv_F2eUT9F60jBl7gQa3H78H3Y0txjaiv_0fDoOvxcdMmMKkDsyUqMSsMWxHk725yiiHCCLfrh8O1z4YTzHvnKhyp6Da-NYroOW3ZGjoBKy3azqku80C789l0iyqMbMesKd95J-X4EagrgU9L3Sa3U8cogeb0tjXbfawd0urKshkc5MgdBeJmALQKw/KOST4066.jpg?format=2500w')
product11 = Product.create(user_id: user1.id, title:'High Way',type_of:'City',category:'cityscape,aerial, city, lights, dark',price:100, image:'https://images.squarespace-cdn.com/content/v1/5567ede4e4b0e2f8eac07860/1477555037698-MROG7PS99VMBL466W67T/ke17ZwdGBToddI8pDm48kLkXF2pIyv_F2eUT9F60jBl7gQa3H78H3Y0txjaiv_0fDoOvxcdMmMKkDsyUqMSsMWxHk725yiiHCCLfrh8O1z4YTzHvnKhyp6Da-NYroOW3ZGjoBKy3azqku80C789l0iyqMbMesKd95J-X4EagrgU9L3Sa3U8cogeb0tjXbfawd0urKshkc5MgdBeJmALQKw/IMG_2642-2.jpg?format=2500w')
...
product13 = Product.create(user_id: user1.id, title:'Hook Thing',type_of:'Aerial',category:'drone, aerial, mavic, dji, moody, nature',price:100, image:'https://i.pinimg.com/originals/9b/43/d5/9b43d58338b5624d4490561298730545.jpg')
product14 = Product.create(user_id: user1.id, title:'Red Island',type_of:'Aerial',category:'drone,nature, sunset, sunrise, lake, river',price:100, image:'https://i.pinimg.com/originals/c5/ff/e4/c5ffe451441f6c02047920e59607bb41.jpg')
product15 = Product.create(user_id: user1.id, title:'NYC Runner',type_of:'Aerial',category:'drone,dubai, city, aerial, sand, warm',price:100, image:'https://i.pinimg.com/originals/a7/98/6b/a7986b1cd176f76f1315eafd8684b28d.jpg')
product16 = Product.create(user_id: user1.id, title:'Autumn Court',type_of:'Aerial',category:'drone, basketball, court, nyc, manhattan, fall, orange',price:100, image:'https://themorningnews.org/images/made/retina/drone-photos-above-new-york-city-by-humza-deas.jpg')
